...
class SearchBox implements OnInit {
	...
	ngOnInit() {
		this.searchResults = [
			...
			{
				type: SearchType.User, obj: {
					id: "yxmfwkcl2", fname: "Jane", lname: "Douglas", email: "jane.douglas@outsidexbox.com",
					meta: {
			...
			{
				type: SearchType.User, obj: {
					id: "31fqm5773", fname: "Evie", lname: "Frye", email: "evie.frye@ubi.com", type: UserType.Faculty,
					meta: {
